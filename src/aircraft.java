 ...
 * @author Vishal
 */
public class aircraft extends javax.swing.JInternalFrame {
    ...
    public void checkgetData()
    {
            ...
            System.out.println(sdf.format(dt)+flno+frm+to+cls+chrg+ecs+dptTime);
    ...
    private void initComponents() {
        ...
        jLabel16.setText("<html> <font size=\"4\"> <ol> <li>B.C.S. = Business Class Seats</li> <li>X.C.S. = Executive Class Seats</li> <li>E.C.S. = Economy Class Seats</li> </ol> </font> </html>");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         checkgetData();
        try{
         String sql="insert into flights values ('"+ sdf.format(dt) + "',"+ "'" + flno +"'" +","+ "'" +dptTime+"'" +","+ cls +","+ chrg +","+ ecs+", '"+frm+"' ,'"+ to +"'" +")"+";";
