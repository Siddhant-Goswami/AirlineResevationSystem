 ...
 * @author Vishal
 */
public class fair extends javax.swing.JInternalFrame {
    ...
    public void checkgetData()
    {
            ...
            chrg=jTextField4.getText();
            cls=jComboBox1.getSelectedItem().toString();
         
            
            System.out.println(flno+frm+to+cls+chrg);
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jComboBox4, javax.swing.GroupLayout.Alignment.LEADING, 0, 131, Short.MAX_VALUE)
                                    .addComponent(jComboBox3, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jComboBox1, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addGap(113, 240, Short.MAX_VALUE))))
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         checkgetData();
        try{
         String sql="insert into sector values ('"+ cls + "',"+   chrg  +", '"+ frm +"' ,"+ "'"+to+"' "+")"+";";
