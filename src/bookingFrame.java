...
public class bookingFrame extends javax.swing.JInternalFrame {
    ...
    public void getSearchData(Date dt,Object o2,Object o3,String ori,String des,String clas)
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
            chrg=Integer.toString(rs.getInt("bfare"));
