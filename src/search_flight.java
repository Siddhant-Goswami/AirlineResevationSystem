...
public class search_flight extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 8, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            else
            {
             ...
             String sql= "select Date,flight_name,departure_time,bcsavailable,xcsavailable,ecsavailable from flights where source="+"'"+jComboBox3.getSelectedItem()+"' and destination='"+jComboBox4.getSelectedItem()+"' and Date='"+strdtver2+"'"+";";
            ...
            Date d;
           if(!rs.isBeforeFirst())
                   JOptionPane.showMessageDialog(this, "Sorry, No flight is available at this moment ", "No data",JOptionPane.INFORMATION_MESSAGE);
            else
             {
            ...
            {
             d=rs.getDate("Date");
             roomtype=rs.getString("flight_name");
             t=rs.getTime("departure_time");
             b=rs.getInt("bcsavailable");
             x=rs.getInt("xcsavailable");
             e=rs.getInt("ecsavailable");
             
             model.addRow(new Object[] {d,roomtype,t,b,x,e});
            }
             }
            }
        }
