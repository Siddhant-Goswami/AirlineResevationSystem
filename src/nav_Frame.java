...
public class nav_Frame extends javax.swing.JFrame {
    ...
    public nav_Frame(login log)
    {
        ...
        try
        {
            img = ImageIO.read(new File("C:\\Users\\siddhant\\Documents\\NetBeansProjects\\AirlineResevationSystem\\src\\cloud.jpg"));
        }
        catch (Exception ex)
        {
            ex.printStackTrace();
    ...
    public void op(int flag)
            {
                aircraftMenuItem.setEnabled(false);
                staffMenuItem.setEnabled(false);
    ...
    private void initComponents() {
        ...
        staffMenuItem.setText("Fair management");
        ...
        aircraftMenuItem.setText("Flight management");
        aircraftMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                aircraftMenuItemActionPerformed(evt);
            }
        });
    ...
    private void aircraftMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aircraftMenuItemActionPerformed
        // TODO add your handling code here:
        jdpDesktop.add(login.af);
        login.af.setVisible(true);
    }//GEN-LAST:event_aircraftMenuItemActionPerformed

    private void staffMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_staffMenuItemActionPerformed
        jdpDesktop.add(login.ff);
        login.ff.setVisible(true);
